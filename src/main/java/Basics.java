...
public class Basics {
    ...
    public static void main(final String[] args) {
        ...
        /* T-ODO (Task 1): Write a line of code below that prints the string
         *                Hello World!
         */
        ...
        /*
         * T-ODO (Task 2): Create a variable named my_variable and assign it the
         *                value 100.
         */
        int my_variable = 100;
        ...
        /*
         * T-ODO (Task 3): Create a for-loop that loops from 10 to 0, printing
    ...
    public static String split(String to_split) {
        /* T-ODO (Task 4): Complete this method body.
    ...
    public static int oddSum(int[] arr) {
        ...
        /* T-ODO (Task 5): Complete this method body using a for-loop.
    ...
    /*
     * T-ODO (Task 6): Submit the changes you made on GitHub!
